    ...
    <div>
        ...
        <b-container fluid class="mt-4">
                    ...
                    <b-table bordered hover :items="cart" :fields="fields">
                        ...
                        <template v-slot:cell(quantity)="data">
                            <b-row>
                                ...
                                <b-col cols="3" class="text-center">
                                    <b-button :disabled="data.item.quantity<=1" variant="primary" @click="increment(data.item.id)" class="mr-2">
                                        +
                                    </b-button>
                                </b-col>
                            </b-row>
            ...
            <b-row class="mt-4 text-center" v-if="cart.length>0">
                ...
                <b-col></b-col>
                <b-col cols="4">Libreria Denavit</b-col>
            ...
            <b-modal hide-header-close no-close-on-esc no-close-on-backdrop ref="modal-1" centered title="Compra exitosa">
                ...
                <ul v-for="productFinal in ticket.products" :key="productFinal.id">
                    <li>
                        Nombre del producto: {{productFinal.name}}
                    </li>
                    <li>
                        Nombre del producto: {{productFinal.name}}
                    </li>
...
export default {
    ...
    data(){
        return{
            ...
            counter: 0,
        cart:[],
        fields:['#','eliminar','imagen','nombre','cantidad','precio']
        }
    },
    methods:{
